			...
			<tbody>
				...
				<tr>
					...
					<td><textarea  class="form-control" name="shipTo"
							style="resize: none;" placeholder="Enter Shipping Address" required>${cartAddress[0]}</textarea>
					</td>
				...
				<tr>
					...
					<td><textarea class="form-control" name="billTo"
							style="resize: none;" placeholder="Enter Billing Address" required>${cartAddress[1]}</textarea>
					</td>

				</tr>

				<tr>
					<td colspan="2"><input type="submit" value="View Invoice"
